# CODEx SWITCH - One-Click Installer for Windows PowerShell
...
if ($ProfileContent -match "function ${AliasName} ") {
    ...
    Add-Content -Path $ProfilePath -Value "`n# CODEx SWITCH`n$AliasStr"
...
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "To start using CODEx SWITCH, please restart your PowerShell or run:"
